...
function calcNetCoi(){var s=parseFloat(document.getElementById('savings').value)||0;var ots=document.getElementById('oneTimeSavings').value;var implDate=document.getElementById('implDate').value;if(ots==='Yes'){document.getElementById('net').value=s.toFixed(2);document.getElementById('coi').value='0.00';return;}if(implDate){var m=new Date(implDate).getMonth()+1;var net=((22-m)/12)*s;document.getElementById('net').value=net.toFixed(2);document.getElementById('coi').value=(s-net).toFixed(2);}else{document.getElementById('net').value='';document.getElementById('coi').value='';}}
</script>`);
};
